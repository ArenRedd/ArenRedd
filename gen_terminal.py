...
# ─── CONFIG ──────────────────────────────────────────────────────────────────
USERNAME     = "ArenRedd"
DISPLAY_NAME = "ArenRedd"
ROLE         = "Cloud Engineer · AWS & DevOps"
...
INFO_ROWS = [
    ...
    {"type": "field",    "label": "Role",     "value": "Cloud Engineer"},
    {"type": "field",    "label": "Focus",    "value": "AWS · DevOps · IaC"},
    {"type": "field",    "label": "Backend",  "value": "Cybersecurity background"},
    {"type": "field",    "label": "Learning", "value": "Kubernetes, Terraform, CDK"},
    # Stack section
    {"type": "section",  "label": "— Stack"},
    {"type": "field",    "label": "Cloud",    "value": "AWS, Terraform, Docker"},
    {"type": "field",    "label": "Compute",  "value": "ECS, Lambda, Fargate"},
    {"type": "field",    "label": "Data",     "value": "RDS, DMS, Glue, S3"},
    {"type": "field",    "label": "Languages","value": "Python, Bash, C, Rust"},
    # Highlights section
    {"type": "section",  "label": "— Highlights"},
    {"type": "bullet",   "value": "4 AWS portfolio projects"},
    {"type": "bullet",   "value": "Blue-green CI/CD on ECS & Lambda"},
    {"type": "bullet",   "value": "Oracle → Aurora PostgreSQL migration"},
    {"type": "bullet",   "value": "Serverless data lake on AWS"},
]
